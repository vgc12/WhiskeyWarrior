...
public class BillDialogueManager : MonoBehaviour
{
    ...
    public void EnterBillDialogueMode(TextAsset inkJSON)
    {
    ...
    private void ExitBillDialogueMode()
    {
        dialougePanel.SetActive(false);
    ...
    private void ContinueBillStory()
    {
        ...
        {
            ExitBillDialogueMode();
        }
    }

    private void DisplayBillChoices()
    {
    ...
    public void MakeBillChoice(int choiceIndex)
    {
