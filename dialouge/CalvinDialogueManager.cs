...
public class CalvinDialogueManager : MonoBehaviour
{
    ...
    [SerializeField] private NavMeshAgent calvinAgent;
    [SerializeField] private Animator calvinAnimator;
    ...
    public void EnterCalvinDialogueMode(TextAsset inkJSON)
    {
    ...
    private void ExitCalvinDialogueMode()
    {
        dialougePanel.SetActive(false);
    ...
    void Update()
    {
        ...
        calvinAnimator.SetFloat("walk", 0);
    ...
    private void ContinueCalvinStory()
    {
        ...
        {
            ExitCalvinDialogueMode();
        }
    }

    private void DisplayCalvinChoices()
    {
    ...
    public void MakeCalvinChoice(int choiceIndex)
    {
